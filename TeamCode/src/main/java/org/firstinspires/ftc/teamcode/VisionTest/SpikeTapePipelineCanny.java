...
public class SpikeTapePipelineCanny extends OpenCvPipeline {
   ...
   public  double minDist = 600;

  public  double p1UpperThreshold = 100;
    // the smaller it is, the more false circles may be detected
 public   double p2AccumulatorThreshold = 20;
...
//        Imgproc.cvtColor(blur, hsvMat, Imgproc.COLOR_BGR2HSV);
        ...
        Imgproc.HoughCircles(gray, circles, Imgproc.CV_HOUGH_GRADIENT, 1.5, minDist, p1UpperThreshold, p2AccumulatorThreshold, minRadius, maxRadius);
        ...
        for (int x = 0; x < circles.cols(); x++) {
            ...
            Imgproc.circle(detected, xy, radius, new Scalar(0, 0, 255), 3);
        }
