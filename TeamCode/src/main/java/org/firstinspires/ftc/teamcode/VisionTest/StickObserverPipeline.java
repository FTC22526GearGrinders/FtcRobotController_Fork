...
public class StickObserverPipeline extends OpenCvPipeline {
    ...
    static double strictLowS = 0;
    static double strictHighS = 255;

   public Scalar strictLowHSV = new Scalar(0, strictLowS, 0); //strict lower bound HSV for yellow
   public Scalar strictHighHSV = new Scalar(255, strictHighS, 255); //strict higher bound HSV for yellow
