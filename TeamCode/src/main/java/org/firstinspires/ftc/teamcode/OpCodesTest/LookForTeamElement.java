...
public class LookForTeamElement extends CommandOpMode {
    ...
    private SpikeTapePipeline stpl;
...
//        if( ActiveMotionValues.getRedAlliance() == true) stpl = new SpikeTapePipeline(true);
//        else stpl = new SpikeTapePipeline(false);
//
//
