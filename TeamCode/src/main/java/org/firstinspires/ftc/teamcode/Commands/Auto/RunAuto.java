...
public class RunAuto extends SequentialCommandGroup {
    ...
    public RunAuto(CommandOpMode opMode, Drive_Subsystem drive, OpenCvWebcam webcam ) {
        ...
        addCommands(
                ...
                new ConditionalCommand(new SelectMotionValuesRed(bbStart,lcr),

                        new SelectMotionValuesBlue(bbStart,lcr), () -> redAlliance),//takes alliance and LCR and sets up data
